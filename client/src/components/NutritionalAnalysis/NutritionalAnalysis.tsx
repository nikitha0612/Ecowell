    ...
    <>
      <Box height={1000}>
        <Stack direction="column" alignItems="center" justifyContent="center">
          <CardMedia
            image={BackgroundImg}
            sx={{ paddingBottom: "100px", width: "100%", height: 1000, alignItems: "center" }}
          >
            <Typography variant="h1" mt={'200px'} textAlign="center" color="black" mb={2} ml={50}>
              Worried about your Nutrition?
            </Typography>
            <Typography variant="h4" textAlign="center" color="#581845" mt={3} ml={50} fontWeight={"bold"}>
              Check nutritional details of your product
            </Typography>
            <Stack direction="row" justifyContent="center" marginTop={3} ml={50}>
              <FormControl sx={{ width: "25ch", justifyContent: "center", mr: 3 }}>
                <OutlinedInput
