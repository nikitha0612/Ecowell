   ...
   {loaded ? (
        <div>
          {statusVerbose === "product not found" ? (
            ...
            <div style={{ backgroundImage: `url(${backgroundImg})`,backgroundColor: "#fff" }}>
              <div
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} md={6}>
                        <img
                          ...
                          alt="Product"
                          style={{ width: "200px", height: "300px", borderRadius: "1.5em" }}
                        />
                      </Grid>
                        ...
                        [...product.ingredients].map((ingredient, index) => (
                          <Grid item xs={12} sm={6} md={4} lg={3} key={index}>
                            <List>
                              <ListItem>
                                <ListItemText
                                  primary={`${index + 1}. ${ingredient.id.slice(3)} (${ingredient.vegetarian === "yes" ? "Vegetarian" : "Non-vegetarian"})`}
                                />
                              </ListItem>
                            </List>
                          </Grid>
